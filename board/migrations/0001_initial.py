        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "thumbnail",
                    models.ImageField(
                        upload_to="column_thumbnial/%Y-%m-%d/", verbose_name="썸네일"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "thumbnail",
                    models.ImageField(
                        upload_to="event_thumbnial/%Y-%m-%d/", verbose_name="썸네일"
                    ),
                ),
                ("content", models.TextField(verbose_name="내용")),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        blank=True, null=True, upload_to="summernote/%Y-%m-%d/"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "thumbnail",
                    models.ImageField(
                        upload_to="news_thumbnial/%Y-%m-%d/", verbose_name="썸네일"
                    ),
                ),
                ("content", models.TextField(verbose_name="내용")),
                ("date", models.DateTimeField(auto_now_add=True, verbose_name="작성일")),
